...
ALTER TABLE sitter_board ADD FOREIGN KEY (sitter_category_code) REFERENCES sitter_category(sitter_category_code);
...
ALTER TABLE neighbor_board_image ADD FOREIGN KEY (neighbor_board_code) REFERENCES neighbor_board(neighbor_board_code);
ALTER TABLE neighbor_board_comment ADD FOREIGN KEY (neighbor_board_code) REFERENCES neighbor_board(neighbor_board_code);
...
-- ALTER TABLE qna_q_board_image ADD FOREIGN KEY (qna_q_code) REFERENCES qna_q_board(qna_q_code);
-- ALTER TABLE qna_q_board ADD FOREIGN KEY (qna_a_code) REFERENCES qna_a_board(qna_a_code);
