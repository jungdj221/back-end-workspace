...
SELECT * FROM address; -- 고객 주소 정보 : address_id, city_id, adress
...
-- required  column: first_name, last_name
-- actor, film, film_actor(actor_id, film_id) : required table
