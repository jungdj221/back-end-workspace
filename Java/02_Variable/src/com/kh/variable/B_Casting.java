...
public class B_Casting {
	 ...
	 * - boolean을 제외한 7개 의 기본형은 서로 형변환이 가능
	 * */
	...
	public void autoCasting() {
		...
		long result3 = 30 + 30; // 30 + 30 = 60, 60을 long 타입으로 변형(60L)
	 ...
	 * */
	public void casting() {
		double d = 4.12345678901234567890; // 20자리이나, 실제 출력에서는 15자리 출력
		...
		System.out.println(bNumber); // -128,// number가 129면 => -127
