...
public class A_TryCatch {
	 ...
	 * 
	 * 에러는 메모리 부족(OutOfMemoryError)이나 스택오버플로우(StackOverFlowError)와 같이 발생하면 복구 할 수 없는 심각한 오류
	...
	public static void main(String[] args) {
		...
		try {
			...
			// printStackTrace() : 예외발생 당시의 호출스책(Call Stack)에 있었던 메서더의 정보와 예외 메시지를 화면에 출력
			// getMessage() : 발생한 예외클ㄹ래스의 갹채애 저장된 메시지를 얻을 수 있음,
		}
	}
