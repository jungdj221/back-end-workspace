...
public class B_Throws {
	 ...
	 * }
	 * 
	 * - main 메서드에서도 throws 키워드로 예외르 떠넘길 수 있지만 
	 *  결국 JVM이 예외 처리를 하게 된다. --> 비추천
	 *  --> 프로그램 사용자는 프로그램이 알 수 없는 예외 내요을 출려하고 종료 되는것을 좋아하지 않음
	 *  - 따라서 main 메서드에서try~catch 블록으올 예외를 최종 처리하는것이 바람직
	 * */
