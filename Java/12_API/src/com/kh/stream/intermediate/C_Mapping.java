...
public class C_Mapping {
	...
	public void method1() {
		...
		System.out.println("수학평균점수 : " + avg); 										// OptionalDouble -> double
		
	}
	
	// flatMapXXX : 하나의 요소흫 복수의 요소들로 구성된 새로운 스트림을 생성한다.
	public void method2() {
	...
	public void method3() {
		...
		Arrays.stream(array2)// array2는 기본자료형 요소
				.boxed() // 사용함으로써 클래스요소로 변경
				.sorted()
				.sorted(Comparator.reverseOrder()) // 클래스요소에만 쓸수있음
				.forEach(System.out::println);
